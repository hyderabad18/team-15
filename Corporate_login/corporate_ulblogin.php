    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 login-sec">
            ...
            <form class="login-form" action="corporate_UlbLoginProcess.php" method="post">
              ...
              <div class="form-group">
                ...
                <label for="UlbUserName" class="text-uppercase" >Corporate email</label>
                <input type="email" class="form-control" placeholder="Enter email" value="<?php if(isset($_COOKIE['remember'])){echo $_COOKIE['user'];} ?>" name="email" required>              
              </div>
              <div class="form-group">
                <label for="UlbPassword" class="text-uppercase">password</label>
                <input type="password" class="form-control" placeholder="Enter password" value="<?php if(isset($_COOKIE['remember'])){echo $_COOKIE['pwd'];} ?>" name="password" required>
              </div>            
