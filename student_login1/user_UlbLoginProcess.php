...
<?php 
  ...
  /*  if ($response["success"] == true) {*/
		...
		require("./user_UlbConnection.php");//Database actions on ulb table (DAO FOR ULB_USERS )// CHANGED  
		$email=$_POST['email'];
		$pwd=$_POST['password'];
	//	$user=new UlbUser;
		...
		if($ulb_dao->authenticateUlb($email,$pwd)==1){
			...
			header("location:user_ulblogin.php"); // CHANGED corporate_ulblogin.php
		}
	}
//	}
	/*else{
