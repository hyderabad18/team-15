...
<?php 
    ...
    if ($response["success"] == true) {
		...
		require("./UlbUser.php");//importing UlbUser class from  UlbUser.php (MODEL for ULB_USERS)  
		require("./UlbConnection.php");//Database actions on ulb table (DAO FOR ULB_USERS ) 
